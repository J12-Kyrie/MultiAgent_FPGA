...
os.environ["PYTORCH_CUDA_ALLOC_CONF"] = "expandable_segments:True,garbage_collection_threshold:0.6"  # 新增
...
with open(filepath, 'r',encoding='utf-8-sig') as file_object:    prompt=file_object.read()
...
try:
    ...
    decoded = tokenizer.decode(sample[0], truncate_before_pattern=[r"endmodule"]) + "endmodule"
    print("\n 生成的 Verilog 代码:\n" + decoded)

...
AES_SCOPE_CONTRACT = BaseContract(
    name='aes_scope',
    lines=(
...
MEMORY_CONSULTATION_DIRECTIVE = PhaseMixin(
...
REPAIR_MEMORY_DIRECTIVE = PhaseMixin(
    name='repair_memory_consultation',
    lines=(
        'Your workspace draft files were originally pre-populated from verified AES reference memory.',
